...
public class Main {
    public static void main(String[] args) throws Exception {
        HoaDon HD1 = new HoaDon.Creater().setHeader(new HoaDonHeader("HD001", "11/05/2020", "Tran Thi Nha Sinh"))
        .addListHD(new CTHD("Banh Mi Ngot", 2, 15000, 0.5f))
        .addListHD(new CTHD("Kem Orio", 1, 20000, 0.5f))
        .build();
        
        HoaDon HD2 = new HoaDon.Creater().setHeader(new HoaDonHeader("HD002", "05/05/2020", "Nguyen Ngoc Y Nhi"))
        .addListHD(new CTHD("Coca Cola", 1, 10000, 0.5f))
        .addListHD(new CTHD("Pepsi", 1, 10000, 0.5f))
        .build();
        
        HoaDon HD3 = new HoaDon.Creater().setHeader(new HoaDonHeader("HD003", "03/05/2020", "Le Thi Kiem Diem"))
